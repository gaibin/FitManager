...
const App: React.FC = () => {
  ...
  const handleSaveSession = async (workoutsData: Omit<Workout, 'id'>[]) => {
    if (!selectedMemberId) return;
    try {
      const newWorkouts = await db.addWorkouts(selectedMemberId, workoutsData);
      ...
      console.error("Failed to add workouts", error);
    }
  };
